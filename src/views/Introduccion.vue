  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      ...
      .col-4.col-lg-3.offset-4.offset-lg-0.align-self-center
        figure
          img(src="@/assets/template/tema-0-3.svg", alt="Texto que describa la imagen").w-75.margin-0-auto.slide-in
          img(src="@/assets/template/tema-0-2.svg", alt="Texto que describa la imagen").w-75.margin-0-auto.state-static
          img(src="@/assets/template/tema-0-4.svg", alt="Texto que describa la imagen").w-75.margin-0-auto.slide-in-car
